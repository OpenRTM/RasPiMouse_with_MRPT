 ...
 * Mapping) algorithm using MRPT (Mobile Robot Programming
 * Toolkit). If you want to know about MRPT, see http://mrpt.org
 * This RT-Component supports only 3 patterns of ICP SLAM.
 * (Actually MRPT supports other types of SLAM). Use with
 * NavigationManager, and Mobile Robot which has common interface
 * for mobile robot. To build this component, please install
 * mrpt-1.3.0. In windows, binary installing is recommended.
  ...
  : public RTC::DataFlowComponentBase
{
 ...
 protected:
   ...
   * Interface: This port provides the services for Mapper.
   *            Please see MobileRobot.idl to know more about the
